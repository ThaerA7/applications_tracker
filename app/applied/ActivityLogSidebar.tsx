// app/your-route/applied/ActivityLogSidebar.tsx
'use client';
...
export type ActivityItem = {
  ...
  appId: string;
  type: ActivityType;
  timestamp: string; // date & time of the action
  company: string;
  role?: string;
  location?: string;
  fromStatus?: string;
...
function getActivityIconSrc(type: ActivityType): string {
  switch (type) {
    ...
    case 'moved_to_interviews':
      return '/icons/add.png'; // or another icon if you have one
    default:
...
type ActivityLogSidebarProps = {
  ...
  onClose: () => void;
  items: ActivityItem[];
  statusClasses: (status: string) => string; // still passed in, unused here
};
    ...
    >
      ...
      <aside
        ...
        className={[
          ...
          'bg-gradient-to-b from-white via-sky-50/70 to-amber-50/70',
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="mt-0.5 text-[11px] text-neutral-600">
                Created, moved, deleted and updated applications.
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3">
          {items.length === 0 ? (
            <div className="mt-8 rounded-xl border border-dashed border-neutral-300/80 bg-white/80 p-5 text-center text-xs text-neutral-600 shadow-sm">
              ...
              <p>
                No activity yet. Actions like adding, editing, moving or
                deleting applications will appear here.
              </p>
            </div>
          ) : (
              ...
              {items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="pointer-events-none absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r from-sky-400 via-fuchsia-400 to-amber-400" />
                    ...
                    <div className="relative space-y-2 pt-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0 space-y-0.5">
                          {/* Role + company on the SAME line, different font settings */}
