...
const DeleteAllDataConfirmDialog: FC<Props> = ({
  open,
  onClose,
  onConfirm,
  busy = false,
      ...
      >
        ...
        <div className="relative z-10 flex items-start justify-between border-b border-rose-100/80 px-5 py-4">
          <div className="flex items-center gap-2">
            <div className="grid h-9 w-9 place-items-center rounded-xl border border-rose-200 bg-white/80">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-neutral-600">
                This permanently removes your lists and activity stored in this {modeLabel ?? "mode"}.
              </p>
            </div>
          </div>
        ...
        <div className="relative z-10 px-5 py-4">
          <div className="rounded-xl border border-rose-100/80 bg-white/90 p-3 text-sm text-neutral-800 shadow-sm">
            ...
            <p className="mt-1 text-xs text-neutral-600">
              Your Applied, Interviews, Notes, Offers, Rejected, Wishlist, Withdrawn and Activity items will be removed.
            </p>
          </div>
